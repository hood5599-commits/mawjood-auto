...
export const CustomerFitmentCheckout: React.FC<Props> = ({
  ...
  const [activeStep, setActiveTab] = useState<'inquire' | 'checkout'>('inquiries_view');
  ...
  // رفع الصور فورياً لسيرفر Supabase Storage
  ...
  const handleCompleteOrder = async (e: React.FormEvent) => {
    ...
    try {
      const payload = {
        ...
        escrow_status: 'held', // المبلغ محتجز في حساب منصة موجود أووتو
